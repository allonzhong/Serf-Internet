...
class panelSystem(common.panelAdmin):
    ...
    def funObj(self):
        ...
        defs = ('GetAllInfo','GetNetWorkApi','GetLoadAverage','ClearSystem','GetNetWorkOld','GetNetWork','GetDiskInfo','GetCpuInfo','GetBootTime','GetSystemVersion','GetMemInfo','GetSystemTotal','GetConcifInfo','ServiceAdmin','ReWeb','RestartServer','ReMemory','RepPanel')
...
class panelPlugin(common.panelAdmin):
    ...
    def funObj(self):
        ...
        defs = ('GetCloudWarning','install','unInstall','getPluginList','getPluginInfo','getPluginStatus','setPluginStatus','a','getCloudPlugin','getConfigHtml','savePluginSort')
...
class panelAuth(common.panelAdmin):
    ...
    def funObj(self):
        ...
        defs = ('flush_pay_status','create_serverid','check_serverid','get_plugin_list','check_plugin','get_buy_code','check_pay_status','get_renew_code','check_renew_code','get_business_plugin','get_ad_list','check_plugin_end','get_plugin_price')
        result = publicObject(toObject,defs);
        return result;
...
class panelPublic:
    ...
    def RequestFun(self):
        ...
        checks = plu.a(get)
        if type(checks) != bool: return public.getJson(checks)
        get.s = get.fun
        result = plu.a(get)
